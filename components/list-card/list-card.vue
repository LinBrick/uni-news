			...
			<view class="listcard-content">
				...
				<view class="listcard-content__des">
					<view class="listcard-content__des-lable">
						<view class="listcard-content__des-lable-item">{{item.classify}}</view>
					</view>
					<view class="listcard-content__des-browse">{{item.browse_count}}浏览量</view>
				</view>
			</view>
		</view>
		<!-- 多图卡片 -->
...
<style lang="scss">
	.listcard {
		...
		.listcard-content__des {
			...
			justify-content: space-between;
			font-size: 12px;
			.listcard-content__des-lable {
				display: flex;
				.listcard-content__des-lable-item {
					padding:0 5px;
					margin-right: 5px;
					border-radius: 15px;
					color: $mk-base-color;
